...
@Component({
  ...
  <div class="flex-child-Index">
    ...
    <h3 style="font-weight: bold; font-size: 20px; color: green" ><a [routerLink]="['/','payment']">Payment</a></h3>
    <br>
...
export class PaymentsComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    this.subscription[5] = this.paymentForm?.valueChanges.subscribe((result: any) => {
  ...
  makeBill() {
    const tempBill = this.paymentForm.value
    const billno = "Pymt-" + this.voucherNo;
    const trans:any = {}
    ...
    this.subscription[6] = this.partyService.searchAccountByName(tempBill.name).subscribe((result:any)=>{
      ...
      this.bill.trans.desc = "Pymt";
      this.bill.trans.billno = "Pymt-" + this.voucherNo;
